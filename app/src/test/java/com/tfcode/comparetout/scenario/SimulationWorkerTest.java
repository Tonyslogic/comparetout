...
public class SimulationWorkerTest {
    ...
    public void processOneRow_OneInverter_OneBattery_AlwaysLoadShift() {
        ...
        SimulationWorker.InputData idata = new SimulationWorker.InputData(inverter, simulationInputData, battery, cfg, null, null);
...
//        expected = load;
    ...
    public void processOneRow_TwoInvertersOneBattery() {
        ...
        SimulationWorker.InputData iData1 = new SimulationWorker.InputData(inverter1, simulationInputData1, battery1, null, null, null);
        ...
        SimulationWorker.InputData iData2 = new SimulationWorker.InputData(inverter2, simulationInputData2, null, null, null, null);
    ...
    public void processOneRow_TwoBatteries() {
        ...
        battery2.setDischargeStop(100d);SimulationWorker.InputData iData2 = new SimulationWorker.InputData(inverter2, simulationInputData2, battery2, null, null, null);
        inputDataMap.put(inverter2, iData2);
    ...
    public void processOneRow_OneBattery() {
        ...
        SimulationWorker.InputData idata = new SimulationWorker.InputData(inverter, simulationInputData, battery, null, null, null);
