...
public class ImportHAGenerateScenario extends Fragment {
    ...
    public static ImportHAGenerateScenario newInstance() {
        return new ImportHAGenerateScenario();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImportHomeAssistantActivity haActivity = ((ImportHomeAssistantActivity)getActivity());
        ...
        mGenerateUsage.setOnClickListener(v -> {
            ...
            if ((null == context) || (haActivity == null)) return;
            ...
            Data inputData = new Data.Builder()
                    ...
                    .putLong(GenerationWorker.SCENARIO_ID, 0L)
                    .putLong(GenerationWorker.LOAD_PROFILE_ID, 0L)
                    .build();
