...
/**
 * Octopus is a meter-only source: import (buy) and export (feed) — the load
 * and PV series never carry data, so their filters are hidden (same as ESBN).
 */
public class ImportOctopusGraphs extends BaseGraphsFragment {

    public ImportOctopusGraphs() {
        // Required empty public constructor
        mImporterType = ComparisonUIViewModel.Importer.OCTOPUS;
    }

    public static ImportOctopusGraphs newInstance() {
        return new ImportOctopusGraphs();
    }
