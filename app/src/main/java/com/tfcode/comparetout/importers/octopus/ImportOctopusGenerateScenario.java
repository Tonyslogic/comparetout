...
import com.tfcode.comparetout.importers.esbn.GenerationWorker;
...
/**
 * Octopus scenario generation. The ESBN GenerationWorker is reused as-is —
 * it is meter-shaped and source-agnostic (keyed on sysSn + date range, builds
 * a load profile from the stored half-hourly `buy` series), which is exactly
 * what Octopus data is.
 */
public class ImportOctopusGenerateScenario extends Fragment {
    ...
    private final boolean mLP = true;

    public ImportOctopusGenerateScenario() {
        // Required empty public constructor
    }

    public static ImportOctopusGenerateScenario newInstance() {
        return new ImportOctopusGenerateScenario();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel.getLiveDateRanges(ComparisonUIViewModel.Importer.OCTOPUS).observe(this, dateRanges -> {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ImportOctopusActivity octopusActivity = ((ImportOctopusActivity) getActivity());
        if (!(null == octopusActivity) && (octopusActivity.getScenarioID() != 0)) {
        ...
        mGenerateUsage.setOnClickListener(v -> {
            ...
            if ((null == context) || (octopusActivity == null)) return;
            ...
            Data inputData = new Data.Builder()
                    ...
                    .putLong(GenerationWorker.SCENARIO_ID, octopusActivity.getScenarioID())
                    .putLong(GenerationWorker.LOAD_PROFILE_ID, octopusActivity.getLoadProfileID())
                    .build();
