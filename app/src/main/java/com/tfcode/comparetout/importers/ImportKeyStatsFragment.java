...
public class ImportKeyStatsFragment extends Fragment {
    ...
    private void setupPopupFilterMenu() {
        if (null == mFilterPopup) {
            ...
            switch (mMonthFilterSelection) {
                case 0:
                    mFilterPopup.getMenu().findItem(R.id.all).setChecked(true);
                    break;
                case 1:
                    mFilterPopup.getMenu().findItem(R.id.jan).setChecked(true);
                    break;
                case 2:
                    mFilterPopup.getMenu().findItem(R.id.feb).setChecked(true);
                    break;
                case 3:
                    mFilterPopup.getMenu().findItem(R.id.mar).setChecked(true);
                    break;
                case 4:
                    mFilterPopup.getMenu().findItem(R.id.apr).setChecked(true);
                    break;
                case 5:
                    mFilterPopup.getMenu().findItem(R.id.may).setChecked(true);
                    break;
                case 6:
                    mFilterPopup.getMenu().findItem(R.id.jun).setChecked(true);
                    break;
                case 7:
                    mFilterPopup.getMenu().findItem(R.id.jul).setChecked(true);
                    break;
                case 8:
                    mFilterPopup.getMenu().findItem(R.id.aug).setChecked(true);
                    break;
                case 9:
                    mFilterPopup.getMenu().findItem(R.id.sep).setChecked(true);
                    break;
                case 10:
                    mFilterPopup.getMenu().findItem(R.id.oct).setChecked(true);
                    break;
                case 11:
                    mFilterPopup.getMenu().findItem(R.id.nov).setChecked(true);
                    break;
                case 12:
                    mFilterPopup.getMenu().findItem(R.id.dec).setChecked(true);
                    break;
            }
        }
